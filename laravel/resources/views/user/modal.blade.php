    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Edit Information</h3>
                    <div class="modal-body">
                        {!! Form::model($data, ['method'=> 'patch','route' =>['user.update', $users->id]]) !!}
                        <div class="mb-3">
                            {!! Form::label('name', 'name') !!}
                            {!! Form::text('name', $users->name, ['class'=> 'form-control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white']) !!}
                        </div>
                    </div>
